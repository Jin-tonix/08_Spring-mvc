package com.example.chptervueresolver;
...
public class ResolverController {
    ...
    public String stringReturning(Model model) {
         ...
         * resourcce/templates/result.html 파일로 응답 뷰를 설정하라는 의미가 된다.
         * */
        return "result";
    }
    ...
    * 하는 기능을 제공한다.
    ...
    @GetMapping("string-reducrect-attr")
    public String stringRidirectFlashAttribute(RedirectAttributes rttr){
        /*
        *리다이렉트 시 falsh 영역에 담아서 redirect 할 수 있다.
        * 자동으로 모델에 추가되기 때문에 requestScpe에서 값을 꺼내면 된다.
